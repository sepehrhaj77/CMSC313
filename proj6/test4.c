 ...
 *  File: test4.c
 *
 *  This file tests if the first block of dynamically allocated memory links to the second block.
 *  Basically, if space is allocated for 5 pointers, and then space is allocated for 5 more, deleting pointers
 *  from the first block of memory should result in the freed space from the first block to still link to the 
 *  space from the second block
 */
